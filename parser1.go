...
func skip(frag *[]byte, lnum *int, seps string) error {
...
func skipWhite(frag *[]byte, lnum *int) error {
...
func parse1Param(txt *[]byte, lnum *int, stab map[string]string) (par interface{}, err error) {
	frag := *txt
...
func parse1VarFun(symbol string, txt *[]byte, lnum *int, stab map[string]string,
	filt bool) (el *VarFunElem, err error) {
...
func parse1(txt *[]byte, lnum *int, stab map[string]string, txt_sep string) (elems []Element, err error) {
